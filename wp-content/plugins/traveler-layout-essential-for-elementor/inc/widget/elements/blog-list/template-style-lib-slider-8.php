...
if ($query_service->have_posts()) { ?>
    <div class="st-list-service st-sliders st-style-arrow horizontal-style2 <?php echo esc_attr($layout_style); ?>" <?php echo st_render_html_attributes($attrs); ?> <?php echo ' data-responsive="' . esc_attr(json_encode($responsive)) . '"'; ?>>
                            ...
                            <div class="item">
                                ...
                                <div class="content-item">
                                    ...
                                    <div class="read-more-lib">
                                        <a href="<?php echo get_the_permalink(); ?>"><?php echo esc_html("Read more", "traveler-layout-essential") ?><span class="stt-icon stt-icon-arrow-right-1"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>

...
if(!class_exists('WB_Form_Builder_Checkout_Controller')){
    class WB_Form_Builder_Checkout_Controller{
        ...
        function _enqueue_scripts(){
            wp_register_style('wb-form-builder', WB_Form_Builder::inst()->get_url('assets/css/form-builder.css'));
            wp_register_script('wb-form-builder-js', WB_Form_Builder::inst()->get_url('assets/js/form-builder.js'), array('jquery'), null, true);
        }

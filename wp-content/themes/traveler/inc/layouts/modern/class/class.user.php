                ...
                switch ($step_name){
                    case 'basic_info':
                        ...
                        if($valid){
                            ...
                            $err = $this->stSetErrorMessage(array('st_title', 'is_featured','st_content',  'cars_logo', 'cars_name'));
                            echo json_encode(array(
                                'status' => false,
                                'err' => $err
                            ));
                    ...
                    if (is_wp_error(self::validation())) {
                        ...
                        if (!is_wp_error($register_user)) {
                            ...
                            echo json_encode([
                                ...
                                'message' => st()->load_template('layouts/modern/common/message', '', ['status' => 'success', 'message' => __('Signup in successfully', 'traveler')]),
                            ]);
                            die;
                        } else {
                            echo json_encode([

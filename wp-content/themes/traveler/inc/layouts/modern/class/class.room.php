<?php
    ...
    if ( !class_exists( 'STRoom' ) ) {
        class STRoom extends TravelerObject
        {
             ...
             * @since 1.2.0
             */
            function get_unavailability_room( $check_in, $check_out, $adult_number = 1, $children_number = 0, $number_room = 1 )
            {
                global $wpdb;
                ...
                if ( $children_number ) {
                    $having .= " OR children_number < {$children_number}";
                }
                if ( $number_room ) {
            ...
            function get_unavailability_room_new( $hotel_parent,$check_in, $check_out, $adult_number, $children_number, $number_room = 1 )
            {
                global $wpdb;
                $check_in  = strtotime( $check_in );
                $check_out = strtotime( $check_out );

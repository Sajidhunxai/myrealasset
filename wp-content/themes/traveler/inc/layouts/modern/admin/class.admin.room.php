...
//                $data['id']=$model->insert($data);
        ...
        function init_metabox()
        {
            ...
            $layout_single = apply_filters('st_layout_single_room',$arr_layout);
            //Room
            $this->metabox[] = [
                'id' => 'room_metabox',
                ...
                'fields' => [
                    ...
                    apply_filters('st_hotel_alone_active',
                        [
                    ...
                    [
                        ...
                        'condition' => apply_filters('hotel_alone_room_layout','hotel_alone_room_layout:is(on)'),
                    ],
                    [
                        ...
                        'condition' => apply_filters('elementor_room_single_layout','hotel_alone_room_layout:is(off)'),
                    ], [
                        'label' => __('Hotel Room Layout', 'traveler'),
                    ...
                    [
                        ...
                        'std' => 'percent',
                        'desc' => __('This use for discount total. Caculation by: amount or %', 'traveler')
                    ],
                    [

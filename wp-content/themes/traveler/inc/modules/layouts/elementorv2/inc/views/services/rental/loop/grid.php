                ...
                <div class="price-wrapper d-flex align-items-end justify-content-between" itemprop="priceRange">
                    <span class="price-tour">
                        <span class="price d-flex align-items-center justify-content-around">
                            ...
                            <?php echo wp_kses(sprintf(__('<span class="price item"> %s</span><span class="unit">/ %d night(s)</span>', 'traveler'), TravelHelper::format_money($min_price), $numberday), ['span' => ['class' => []]]) ?>
                        </span>
                    </span>

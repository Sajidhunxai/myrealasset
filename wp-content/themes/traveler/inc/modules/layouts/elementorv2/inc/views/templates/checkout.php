...
?>  
    <div id="st-content-wrapper" class="st-style-elementor">
        ...
        <div class="container">
            <div class="st-checkout-page style-2">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-8 col-12 order-2 order-sm-1">
                                ...
                                <div class="check-out-form">
                                    ...
                                    <form id="cc-form" class="" method="post" onsubmit="return false">
                                        <?php echo stt_elementorv2()->loadView('pages/checkout/checkout-form') ?>
                                        <?php
                        ...
                        <?php } else { ?>
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="check-out-form">
                                    <div class="entry-content">
                                        <a href="#" class="dropdown-toggle btn btn-green form-login" data-bs-toggle="modal" data-bs-target="#st-login-form">
                                            <?php echo __('Login', 'traveler'); ?>
                                        </a>

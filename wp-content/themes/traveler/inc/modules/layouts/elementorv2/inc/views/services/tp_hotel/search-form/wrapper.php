    ...
    <form role="search" method="get" class="form search main-search tp_hotel" action="<?php echo esc_attr($action);?>" target="<?php echo esc_attr($target)?>">
        ...
        <div class="row">
            <div class="col-md-4 col-lg-4">
                <?php echo stt_elementorv2()->loadView('services/travelpayouts_api/search/hotel/location', '', [ 'has_icon' => true ] ) ?>
            </div>
            <div class="col-md-3 col-lg-4">
                <?php echo stt_elementorv2()->loadView('services/travelpayouts_api/search/hotel/date', '', [ 'has_icon' => true ] ) ?>
            </div>
            <div class="col-md-3 col-lg-2">
                <?php echo stt_elementorv2()->loadView('services/travelpayouts_api/search/hotel/guest', '', [ 'has_icon' => true ] ) ?>
            </div>
            <div class="col-md-2 col-lg-2">
                <?php echo stt_elementorv2()->loadView('services/travelpayouts_api/search/hotel/advanced', '' ) ?>
            </div>
        </div>
    </form>
</div>

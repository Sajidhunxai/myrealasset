...
<div class="total-section">
    <ul>
        ...
        ?>
        <?php
        $total_bulk_diccount = !empty($item['data']['total_bulk_diccount']) ? floatval($item['data']['total_bulk_diccount']): 0;
            if($total_bulk_diccount > 0){ ?>
                <li>
                    <span class="label"><?php echo __('Bulk Discount', 'traveler'); ?></span>
                    <span class="value"> - <?php echo TravelHelper::format_money($total_bulk_diccount); ?></span>
                </li>
            <?php }
        ?>

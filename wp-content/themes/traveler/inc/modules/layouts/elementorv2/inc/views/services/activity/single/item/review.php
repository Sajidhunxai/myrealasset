        ...
        <div id="reviews" class="st-reviews">
            ...
            <div class="review-pagination">
                <div class="summary text-center">
                    ...
                    ?>
                    <?php comments_number(__('0 review on this Activity', 'traveler'), __('1 review on this Activity', 'traveler'), __('% reviews on this Activity', 'traveler')); ?>
                ...
                <div id="reviews" class="review-list">
                    ...
                    if ($comments):
                        foreach ($comments as $key => $comment):
                            echo stt_elementorv2()->loadView('services/common/single/review-list',['comment' => (object)$comment, 'post_type' => 'st_activity']);
                        endforeach;
                    endif;
                    ?>
                </div>

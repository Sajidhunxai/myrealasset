        ...
        <div class="row align-items-center">
            ...
            <div class="col-xs-12 col-md-8">
                <div class="row align-items-center">
                    <div class="col-xs-12 col-md-8">
                        <h2 class="heading">
                            <a href="<?php echo esc_url($link_with_params) ?>" class="c-main">
                                <?php echo get_the_title($room_id); ?>
                            </a>
                        </h2>
                        <div class="facilities">
                            <?php if ( $room_footage = get_post_meta( $room_id, 'room_footage', true ) ): ?>
                                <p class="item text-center" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-toggle="tooltip" data-placement="top" title="<?php echo __('Room Footage', 'traveler') ?>">
                            ...
                            <?php if ( $bed = get_post_meta( $room_id, 'bed_number', true ) ): ?>
                                <p class="item text-center" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-toggle="tooltip" data-placement="top" title="<?php echo __('No. Beds', 'traveler') ?>">
                            ...
                            <?php if ( $adult = (int)get_post_meta( $room_id, 'adult_number', true ) ): ?>
                                <p class="item text-center" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-toggle="tooltip" data-placement="top" title="<?php echo __('No. Adults', 'traveler') ?>">
                            ...
                            <?php if ( $child = (int)get_post_meta( $room_id, 'children_number', true ) ): ?>
                                <p class="item text-center" data-bs-html="true" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-toggle="tooltip" data-placement="top" title="<?php echo __('No. Children', 'traveler') ?>">
                    ...
                    <div class="col-xs-12 col-md-4">
                        <?php
                            ...
                            <?php } else {
                                ?>
                                <a href="#"
                                   class="btn-show-price btn btn-primary st-btn-second upper mt5"><?php echo esc_html__( 'Show Price', 'traveler' ) ?></a>
                            <?php } ?>
                    </div>
                </div>
            </div>

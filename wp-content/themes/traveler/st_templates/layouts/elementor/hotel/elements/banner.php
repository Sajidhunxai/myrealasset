                            ...
                            <div class="search-form-mobile">
                                <div class="st-border-radius form-group">
                                    <div class="form-extra-field">
                                        <div class="dropdown dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown" id="dropdown-destination" role="menu" data-bs-toggle="dropdown" aria-expanded="false">

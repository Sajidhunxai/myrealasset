                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-9 col-md-9">
                            ...
                            echo st()->load_template('layouts/elementor/tour/single/item/infor', '', array('tour_type' => $tour_type)); ?>
                            <!--Tour Overview-->
                            <?php echo st()->load_template('layouts/elementor/tour/single/item/gallery', '', array('gallery_array' => $gallery_array)); ?>

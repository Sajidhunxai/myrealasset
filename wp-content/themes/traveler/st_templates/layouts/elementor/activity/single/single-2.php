<?php
    ...
    while ( have_posts() ): the_post();
        ...
        ?>
        <div id="st-content-wrapper" class="st-single-tour st_single_activity style-2">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-9 col-md-9">
                            ...
                            <!--End Tour info-->
                            <?php echo st()->load_template('layouts/elementor/activity/single/item/gallery', '', array('gallery_array' => $gallery_array)); ?>
                            <!--Tour Overview-->

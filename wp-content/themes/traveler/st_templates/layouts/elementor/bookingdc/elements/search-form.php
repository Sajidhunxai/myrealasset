...
?>
<div class="search-form hotel-search-form-home hotel-search-form st-border-radius <?php echo esc_attr($class); ?>">
 <?php if ($bdc_status_iframe == 'on') {
        ...
        ?>
        <form action="<?php echo esc_url($domain . $target_page); ?>" class="form bookingdc" method="get">
            ...
            <div class="row">
                <div class="col-md-4 border-right">
                    <?php echo st()->load_template( 'layouts/elementor/bookingdc/search/location', '', [ 'has_icon' => true ] ) ?>
                </div>
                <div class="col-md-3">
                    <?php echo st()->load_template( 'layouts/elementor/bookingdc/search/date', '', [ 'has_icon' => true ] ) ?>
                </div>
                <div class="col-md-3">
                    <?php echo st()->load_template( 'layouts/elementor/bookingdc/search/guest', '', [ 'has_icon' => true ] ) ?>
                </div>
                <div class="col-md-2">
                    <?php echo st()->load_template( 'layouts/elementor/bookingdc/search/advanced', '' ) ?>
                </div>
            </div>
        </form>
    <?php }?>
